...
sudo dpkg -i discord*
sudo add-apt-repository ppa:chronobserver/betterdiscordctl -y
sudo apt update
sudo apt install betterdiscordctl -y
...
### VSCode
```bash
wget https://raw.githubusercontent.com/charleywright/Themes/master/Keybinds.json -O ~/.config/Code/User/keybindings.json
